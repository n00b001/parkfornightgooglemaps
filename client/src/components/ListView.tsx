		...
		<div className="h-[calc(100vh-64px)] overflow-y-auto bg-gray-50 pb-32 pt-4 custom-scrollbar">
			<div className="max-w-2xl mx-auto px-4 space-y-4">
				...
				{places.map((place) => {
					...
					const photo = place.photos?.[0]?.r2_url_thumb;
					return (
						<div
							key={place.id}
							...
							<div className="flex-1 p-5 flex flex-col justify-between">
								<div>
									...
									<div className="flex items-center gap-3 mt-1">
										...
										<span
											className={`text-[10px] font-bold px-2 py-0.5 rounded-full uppercase ${TYPE_COLORS[place.type || ""] || "bg-gray-100 text-gray-600"}`}
										>
